package ru.sagamatrix.app.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ru.sagamatrix.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ru.sagamatrix.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
